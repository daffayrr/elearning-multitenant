...
class StudentController extends BaseController
{
    public function index(string $tenantStringId)
    {
        ...
        return view('tenant_admin/students/index', [
            'students' => $students, 
    ...
    public function block(string $tenantStringId, int $id)
    {
        $userModel = new UserModel();
    ...
    public function unblock(string $tenantStringId, int $id)
    {
        $userModel = new UserModel();
        $userModel->update($id, ['is_blocked' => 0]);
        
        return redirect()->back()->with('success', 'Blokir siswa berhasil dibuka.');
    }
